...
class TestTambahDataVacancies(unittest.TestCase):
    def setUp(self):
    ...
    def test_tambah(self):
        ...
        time.sleep(5)
        driver.find_element(By.XPATH,"//div[@id='app']/div[@class='oxd-layout']//form[@class='oxd-form']/div[1]/div[1]/div//input").send_keys("A Senior QA Lead")
        time.sleep(5)
        driver.find_element(By.XPATH,"//div[@class='oxd-select-text oxd-select-text--active']").click()
        time.sleep(5)
        driver.find_element(By.XPATH,"//div[@class='oxd-select-text-input']").send_keys("sss")
        time.sleep(5)
        driver.find_element(By.XPATH,"//div[@role='listbox']").click()
        time.sleep(5)
        driver.find_element(By.XPATH,"//textarea[@placeholder='Type description here']").send_keys("Deskipsi QA")
        time.sleep(5)
